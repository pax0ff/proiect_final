...
mixin _$GetReviews {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int movieId) $default, {
...
class _$GetReviewsStartImpl implements GetReviewsStart {
  const _$GetReviewsStartImpl(this.movieId);
  ...
  @override
  String toString() {
    return 'GetReviews(movieId: $movieId)';
  }
...
abstract class GetReviewsStart implements GetReviews {
  const factory GetReviewsStart(final int movieId) = _$GetReviewsStartImpl;
